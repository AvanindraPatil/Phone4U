<!-- <?php
        ...
        //     // dd($average_score);
        //     $id = $row['phone_id'];
        //     $query = "UPDATE score set average = $average_score WHERE phone_id = $id";
        ...
        <form id="survey-form" action="result.php" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" style="width: 100%;" name="budget">
                    ...
                    <option>&#8377;60000 - 1,50,000</option>
                </select>
            </div>
            <div class="form-group">
                <label for="check" class="lbl-chkbx"><input type="checkbox" id="check" name="lowerThanBudget" class="">Show phones lower than budget?</label>
            </div>
            <!-- </div> -->
